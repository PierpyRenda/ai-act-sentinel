...
ANNEX_III_CATEGORIES = [
    {
        ...
        "keywords": ["biometric", "facial recognition", "riconoscimento facciale", "emozioni", "emotion recognition",
                     "fingerprint", "impronta", "iride", "voice recognition", "voce biometrica", "identificazione remota"],
    },
    {
        "id": "annex3_2",
        ...
        "keywords": ["infrastruttura critica", "critical infrastructure", "traffic management", "gestione traffico",
                     "acqua", "gas", "elettricità", "electricity", "riscaldamento", "heating", "supply management"],
    },
    {
        "id": "annex3_3",
        ...
        "keywords": ["educazione", "education", "scuola", "school", "università", "university", "studenti", "students",
                     "ammissione", "admission", "esame", "exam", "valutazione apprendimento", "learning assessment",
                     "monitoraggio esame", "exam monitoring"],
    },
    {
        "id": "annex3_4",
        ...
        "keywords": ["assunzione", "recruitment", "selezione", "hiring", "candidato", "candidate", "lavoratori", "workers",
                     "dipendenti", "employees", "licenziamento", "termination", "promozione", "promotion",
                     "monitoraggio dipendenti", "employee monitoring", "performance", "prestazioni"],
    },
    {
        "id": "annex3_5",
        ...
        "keywords": ["credito", "creditworthiness", "merito creditizio", "scoring", "servizi pubblici", "public services",
                     "sussidi", "benefits", "emergenza", "emergency", "triage", "assicurazione", "insurance",
                     "vita", "salute", "health", "allocazione risorse", "resource allocation"],
    },
    {
        "id": "annex3_6",
        ...
        "keywords": ["forze dell'ordine", "law enforcement", "polizia", "police", "crimine", "crime", "recidiva", "recidivism",
                     "profiling criminale", "criminal profiling", "rischio criminale", "criminal risk", "prova", "evidence",
                     "poligrafo", "polygraph", "indagine", "investigation"],
    },
    {
        "id": "annex3_7",
        ...
        "keywords": ["migrazione", "migration", "asilo", "asylum", "frontiera", "border", "visto", "visa",
                     "permesso soggiorno", "residence permit", "rifugiati", "refugees", "immigrazione", "immigration",
                     "documenti viaggio", "travel documents"],
    },
    {
        "id": "annex3_8",
        ...
        "keywords": ["giustizia", "justice", "giudici", "judges", "decisioni giudiziarie", "judicial decisions",
                     "elezioni", "elections", "voto", "voting", "referendum", "democrazia", "democracy",
                     "arbitrato", "arbitration", "mediazione", "mediation"],
    },
]
